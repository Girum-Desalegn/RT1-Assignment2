...
class Position_speed:
	def __init__(self):
		"""
        This is the constructor method of the *Position_speed* class.
        It initializes some variables and sets up a subscriber to 
        listen to the */velxz_posxy* topic and */reaching_goal/goal*.
	...
	def callback(self,msg):
		"""
  		This callback function extracts the necessary information from the custom message
        and calculates the distance and average velocity. 
	...
	def call_pos_vel(self,req):
		"""
		This function response the distance between desired position and actual position and 
  		also return the average velocity of robot when call *service_subscriber* service.
